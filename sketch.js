...
// Teacher the following part is the part of the code where something has gone wrong. You have said to submit this code as a project, and that you will fix it.
function bMove () {
  console.log("I'll not move")
...
function gameOver1 () {
  swal(
    {
      title: "Points!!",
      text: "You have  /*Points*/ Points, Congragulations!!!",
      confirmButtonText: "Close"
    })
  }
    function cButton (isConfirm) {
      if (isConfirm) {
        location.reload ();
      }
    }
